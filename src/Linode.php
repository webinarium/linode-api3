 ...
 */
class Linode extends BaseLinodeApi
{
    /**
     ...
     * @param   integer $ConfigID [optional] The ConfigID to boot, available from linode.config.list().
     *
     * @return  array
     */
     ...
     *
     * @param   integer $LinodeID   [required] The LinodeID to delete
     * @param   boolean $skipChecks [optional] Skips the safety checks and will always delete the Linode
     *
     * @return  array
     */
     ...
     *
     * @param   integer $LinodeID [optional] Limits the list to the specified LinodeID
     *
     * @return  array
     */
