...
$params_order = array(
    ...
    'avail.kernels'                      => array('KernelID', 'isXen', 'isKVM'),
    ...
    'linode.clone'                       => array('LinodeID', 'DatacenterID', 'PlanID', 'PaymentTerm'),
    ...
    'nodebalancer.config.create'         => array('NodeBalancerID', 'Port', 'Protocol', 'Algorithm', 'Stickiness', 'check', 'check_interval', 'check_timeout', 'check_attempts', 'check_path', 'check_body', 'check_passive', 'ssl_cert', 'ssl_key'),
    'nodebalancer.config.delete'         => array('NodeBalancerID', 'ConfigID'),
    'nodebalancer.config.list'           => array('NodeBalancerID', 'ConfigID'),
    'nodebalancer.config.update'         => array('ConfigID', 'Port', 'Protocol', 'Algorithm', 'Stickiness', 'check', 'check_interval', 'check_timeout', 'check_attempts', 'check_path', 'check_body', 'check_passive', 'ssl_cert', 'ssl_key'),
